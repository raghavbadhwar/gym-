...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # Performance optimization: Replace N+1 counts (6 queries) with a single GROUP BY query
        # Expected impact: Reduces database hits from 6 to 2, significantly improving response time
        ...
        # SQLAlchemy may return raw Enum instances depending on the dialect mapping
        counts = {}
