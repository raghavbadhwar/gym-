...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # ⚡ Bolt Optimization: Replace 6 separate count queries with a single grouped query
        state_counts_query = self.db.query(Member.current_state, func.count()).group_by(Member.current_state).all()
