...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # ⚡ Bolt Optimization: Calculate overall total including null states
        total = self.db.query(Member).count()

        # ⚡ Bolt Optimization: Replaced 5 individual .count() queries with a single GROUP BY query.
        # Expected Impact: Reduces database roundtrips from 6 to 2, significantly improving response time.
        state_counts = dict(
