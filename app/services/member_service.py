...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # ⚡ Bolt Optimization: Resolves N+1 queries by grouping counts into a single query.
        # Expected Impact: Reduces 6 separate database calls to 1, significantly improving dashboard load time.
        counts = dict(self.db.query(Member.current_state, func.count(Member.id)).group_by(Member.current_state).all())
