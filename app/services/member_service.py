...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # ⚡ Bolt Optimization: Replaced multiple N+1 .count() queries with a single .group_by() query.
        # This reduces database roundtrips from 5 sequential queries to 1, significantly improving performance.
        state_counts = dict(
