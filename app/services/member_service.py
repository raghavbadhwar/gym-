...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # Performance Optimization: Calculate total separately to include members with NULL state.
        # Then, group by current_state to compute state counts in a single query instead of five separate count queries.
