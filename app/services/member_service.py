...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # Calculate overall total separately to include records with NULL states.
        total = self.db.query(Member).count()

        # Optimize: Calculate state counts in a single group-by query.
        # This replaces 5 individual .count() queries with 1 query, reducing database roundtrips and latency.
        state_counts = dict(
