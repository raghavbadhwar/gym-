...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # Optimization: Fetch all state counts in a single query using group_by
        # This replaces 6 separate database queries with just 1
        state_counts = dict(
        ...
        # Calculate total by summing the values of the retrieved state counts
