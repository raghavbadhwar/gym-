...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # ⚡ Bolt Optimization: Calculate total separately to include any NULL states,
        # then use a single GROUP BY query for all other state counts.
        # This reduces the number of DB queries from 6 to 2, significantly improving performance.
        ...
        counts = {state: count for state, count in state_counts_query}
