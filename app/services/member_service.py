...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # This resolves an N+1 style query issue and reduces database roundtrips from 6 to 1,
        # significantly improving the performance of the dashboard stats endpoint.
        state_counts = dict(
