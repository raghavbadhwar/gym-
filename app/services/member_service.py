...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # ⚡ Optimization: Calculate total separately to include null states,
        # then group by state for counts to reduce N+1 queries from 6 down to 2.
        # Expected impact: Significantly reduces latency on dashboard load.
