...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # Calculate total separately to ensure members without mapped states are accurately counted
        total = self.db.query(Member).count()
        
        # Optimize performance by using a single group_by query instead of multiple .count() queries
        # This reduces database trips from 6 to 2
        ...
        # Map SQL enum results to lowercase dictionary keys safely
