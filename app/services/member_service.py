...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # Optimization: Refactored 6 database queries into a single GROUP BY query.
        # This reduces database load and network latency, significantly improving response times.
