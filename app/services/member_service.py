...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # ⚡ Optimization: Reduced 5 individual .count() queries into a single GROUP BY query
        # This prevents 5 separate round-trips to the database, improving performance on the dashboard load
        state_counts_query = self.db.query(Member.current_state, func.count(Member.id))\
