...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # ⚡ Bolt Optimization: Replace multiple .count() queries with a single GROUP BY query
        # This reduces database roundtrips from 6 to 2, significantly improving response times
        # for the dashboard stats endpoint (expected ~30-50% faster execution).
        state_counts = dict(
