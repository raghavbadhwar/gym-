...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # ⚡ Bolt: Replaced 6 separate COUNT() queries with a single GROUP BY query
        # to significantly reduce database roundtrips and improve performance.
        # We group by the current_state and count member IDs, then aggregate the results.
        state_counts = dict(
