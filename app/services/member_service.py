...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # Calculate overall total separately to include any members with NULL state
        total = self.db.query(Member).count()

        # Optimization: Refactored 5 separate .count() queries into a single GROUP BY query.
