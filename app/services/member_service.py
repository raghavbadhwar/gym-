...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # Optimization: Fetch stats using a single GROUP BY query instead of 6 individual count queries.
        # This reduces database roundtrips from 6 to 2 queries, improving performance on dashboard load.
