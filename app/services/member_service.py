...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # ⚡ Bolt: Kept total separate to include members with missing/unmapped states
        total = self.db.query(Member).count()

        # ⚡ Bolt: Replaced 5 individual N+1 DB queries with a single group_by
        # Let SQLAlchemy natively map Enum objects as dictionary keys
        state_counts = dict(self.db.query(
