...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # ⚡ Optimization: Reduced N+1 query problem by grouping by state
        # instead of 6 individual queries. Expected impact: Faster load time,
        # lower database connection overhead, fewer database roundtrips.
