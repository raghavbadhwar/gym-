...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # Performance optimization: Replaced 5 individual N+1 count queries with a single GROUP BY query.
        # This reduces database roundtrips and significantly improves dashboard load time.
        ...
        # Use raw Enum instance as key to match MemberState usage
