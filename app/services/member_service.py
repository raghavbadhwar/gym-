...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # Optimization: Replaced 5 individual COUNT queries with a single GROUP BY query,
        # reducing DB roundtrips and execution time. Kept total calculation separate to include NULL states.
