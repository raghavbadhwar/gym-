...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # Optimization: Reduced 6 separate .count() queries down to a single grouped query.
        # Expected performance impact: Significantly reduces database roundtrips and execution time.
