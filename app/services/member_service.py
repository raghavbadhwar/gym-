...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # ⚡ Bolt Optimization: Refactored individual COUNT queries into a single GROUP BY query
        # This reduces database roundtrips and improves dashboard load times significantly.
