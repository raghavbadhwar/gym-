...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # Calculate overall total separately to include records where current_state might be NULL
        total = self.db.query(Member).count()

        # Optimize by grouping state queries to reduce database roundtrips
        state_counts = dict(
