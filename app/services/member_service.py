...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # Optimization: Replaced multiple .count() queries with a single GROUP BY query to reduce DB roundtrips and improve performance.
        ...
        state_counts = {state: count for state, count in state_counts_query if state is not None}
