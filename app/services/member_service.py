...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # ⚡ BOLT OPTIMIZATION: Replacing 6 separate COUNT queries with a single GROUP BY query.
        # This resolves an N+1 style query issue, significantly reducing database load
        # and latency during a call to the get_stats function.
        state_counts = dict(
        ...
        # Calculate total by summing the counts
