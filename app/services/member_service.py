...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # ⚡ Bolt Optimization: Calculate total separately to include null states,
        # then use a single GROUP BY query for all other states to reduce DB queries from 6 to 2.
