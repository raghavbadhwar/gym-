...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # Performance optimization: Replace 6 separate COUNT queries with a single GROUP BY query.
        # This reduces database roundtrips and significantly improves response time.
        ...
        # When querying with SQLAlchemy group_by on an Enum column, the returned dictionary
        # keys are Python Enum members, requiring lookup by the Enum object.
