...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # ⚡ Bolt Optimization: Replace 6 separate N+1 COUNT queries with a single GROUP BY query
        # and one separate overall query to capture members with NULL states.
        ...
        state_counts = {state: count for state, count in counts if state is not None}
