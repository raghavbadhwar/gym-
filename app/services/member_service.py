...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # ⚡ BOLT OPTIMIZATION: Replaced 5 separate .count() queries with a single GROUP BY query.
        # This resolves an N+1 query pattern, reducing database roundtrips from 6 to 2.
