...
class MemberService:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        # ⚡ Bolt Optimization: Calculate total separately since current_state is nullable,
        # then use a single GROUP BY query for the states to reduce N+1 queries.
        # Expected Impact: Replaces 6 database queries with 2, significantly reducing DB load and latency.
