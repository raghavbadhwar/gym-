...
async def verify_webhook(
    ...
    if hub_mode == "subscribe" and hub_verify_token is not None and settings.whatsapp_verify_token is not None:
        # Encode tokens to utf-8 bytes before passing them to hmac.compare_digest.
        # This prevents TypeError exceptions caused by non-ASCII characters, which could act as a Denial of Service (DoS) vulnerability.
