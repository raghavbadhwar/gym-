...
async def verify_webhook(
    ...
    if hub_mode == "subscribe" and hub_verify_token is not None and settings.whatsapp_verify_token is not None:
        # Security: Encode strings to bytes before comparing to prevent timing attacks
        # specific to different encodings or early exits on string length differences.
